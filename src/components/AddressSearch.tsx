...
export default function AddressSearch({ value, onChange, placeholder }: AddressSearchProps) {
  ...
  const inputCls = 'w-full border border-card-border rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-orange bg-card text-foreground placeholder:text-muted';
